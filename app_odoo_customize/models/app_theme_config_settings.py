...
class AppThemeConfigSettings(models.TransientModel):
    ...
    app_account_title = fields.Char('My Account Title')
    app_account_url = fields.Char('My Account Url')


    @api.model
    def get_default_all(self, fields):
        ir_config = self.env['ir.config_parameter']
        app_system_name = ir_config.get_param('app.window_title', default='odoo')
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url', default='#')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url', default='#')
    ...
    def set_default_all(self):
        ...
        ir_config.set_param("app_documentation_url", self.app_documentation_url or "#")
        ir_config.set_param("app_documentation_dev_url", self.app_documentation_dev_url or "#")
