...
from odoo.addons.base.ir.ir_qweb.qweb import unicodifier
from odoo.addons.base.ir.ir_qweb.fields import nl2br, html_escape
import json
...
class Contact(models.AbstractModel):
    ...
    def value_to_html(self, value, options):
        ...
        myval = self.env['ir.qweb'].render('base.contact', val);
        return myval
